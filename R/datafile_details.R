datafile_details <-
function() {
# Ici, l'utilisateur est invité à fournir des détails de mise en forme à propos de son fichier
...
# Affichage
##
tkgrid(tklabel(start,text=paste("In your data file(s), does...", sep=""),font="bold"))
tkgrid(frame_header)
